...
public class crew extends AppCompatActivity {
    ...
    Button btn_search, btn_next, btn_prev, btn_add, btnRFID;
    ListView lv_crew;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_search=findViewById(R.id.txt_searchC);
        btn_search=findViewById(R.id.btn_searchC);
        lv_crew=findViewById(R.id.lv_crew);
        txv_pages=findViewById(R.id.txv_pagesC);
        btn_next=findViewById(R.id.btn_nextC);
        btn_prev=findViewById(R.id.btn_previousC);
        btn_add=findViewById(R.id.btn_addC);
        btnRFID=findViewById(R.id.btn_rfidC);
        pageNo=0;
        totpage=0;

        btn_add.setEnabled(GlobalVar.crew_add);
        ...
        lv_crew.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int pos, long l) {
                view_crew_details(((TextView) view).getText().toString(),stateid.get(pos));
            }
        });
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(crew.this, crewaddedit.class);
    ...
    private void view_vessel_details(String name){
        Intent intent = new Intent(crew.this, vesseladdedit.class);
    ...
    public void selctshow(View v){
        this.finish();
    }

    public void searchcrew(View v)   {
        pageNo=1;
        show_records();
    }
    ...
    void show_records(){
        String url = GlobalVar.server_address +"/androidjson/crewlist.php";
        String srch = txt_search.getText().toString();
        String postval =  "?&u="+GlobalVar.Muser+"&g="+ String.valueOf(pageNo)+"&s="+srch;
                    ...
                    if (data.contains("value") ){
                        ...
                        for (int i = 0; i < ja.length(); i++) {
                            ...
                            if(i==0){
                                ...
                                String name = jo.getString("Crewname");
                                String aadhar = jo.getString("AadharNo");
                                holder.add(aadhar + "- " + name);
                                stateid.add(Comfun.json_string(jo,"state_id"));
                            }
                        }
                        ArrayAdapter<String> at = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1, holder);
                        lv_crew.setAdapter(at);
